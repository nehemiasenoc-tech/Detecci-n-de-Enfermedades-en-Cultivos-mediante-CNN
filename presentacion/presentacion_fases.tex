...
\begin{frame}{Fase 3 — Curvas de entrenamiento}
  \centering
  \includegraphics[width=0.62\textwidth]{images/cnn_custom_training.png}
  \vspace{0.2cm}
  \footnotesize
  \begin{itemize}
    \item Entrenamiento de 41 épocas: el accuracy de validación converge rápido (supera 90\% desde la época 5) y se estabiliza cerca del 99\% a partir de la época 20, con algo de ruido puntual típico de mini-batches pequeños.
    \item Mejor checkpoint guardado en la época 36 (99.73\% val accuracy) — el loss de validación baja de forma consistente, sin señales de sobreajuste.
  \end{itemize}
\end{frame}
